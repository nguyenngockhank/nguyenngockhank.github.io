# 7.  Dierent Layer, Dierent Abstraction
...
underlying InputStream to read a much larger block, and saves the extra
...
class shallow and awkward to use. In the higher-level user interface code,
